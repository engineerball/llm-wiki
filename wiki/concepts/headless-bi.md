...
- **Universal Accessibility:** Metrics are defined once and accessed via APIs (REST, GraphQL, SQL) by any downstream consumer, including multiple different BI tools, custom web apps, and [[generative-ai|generative AI]] agents.
...
- [[cube|Cube]]: A primary leader in the headless BI space.
- [[dbt-labs|dbt Semantic Layer]]: Provides headless metric capabilities for dbt-centered stacks.
- [[atscale|AtScale]]: Offers enterprise-grade universal semantic modeling.
